            ...
            <div class="box-body ">
              <form action="../empresaRubros/" method="POST">
               ...
               <div class="form-group col-md-8" >
                  <?php  ?>
                  <input type="text" name="n" class="form-control" value="<?php if($dir['DRT_D_NOMBRE']==""){ echo $emp['EMP_D_NOMBRECOMERCIAL']; } else { echo $dir['DRT_D_NOMBRE']; }?>">
              ...
              <input type="hidden" name="u" id="u" value="<?php echo $usuario['US_C_CODIGO'];?>">
                  ...
                  <input type="submit" name="evento" class="btn btn-success" value="Actualizar" >
                  <?php } else { ?>
