...
var sec=$("#sec").val();
  ...
  var url="../Vistas/campanadirectorio/ajaxrubros.php";
  
  $('#tablajson tbody').html('');
    $.ajax({
           type: "GET",
           url: url,
           data: {txt: buscar,s: sec}, // Adjuntar los campos del formulario enviado.
        ...
        <div class="col-md-4">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Ingresar categoria</h4>
            </div>
            <div class="box-body">
            	<form action="../ingresarRubros/" method="POST">
         ...
         <div class="col-md-8">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">Modifcar Rubro</h4>
            </div>
            <div class="box-body">
            
              <div class="form-group col-md-4">
                  
	             <select class="form-control" id="sec"  onchange="buscar1()">
	             	<option value="">Seclecciona Sector</option>
	              	<option value="36">Minería</option>
		            <option value="39">Construción</option>
	              </select>
              </div>
...
$('#editarRubro').on('show.bs.modal', function (event) {
  ...
  modal.find('.modal-rubro').text('Sector: '+ sector)
