          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <div id="ubigeo" class="form-group col-md-12">
                
                </div>
                <div class="form-group col-md-12">
                <form id="fmrubigeo">
                <div id="pais" class=" col-md-3">

                  <select class="form-control" onchange="estados(this)" id="p">
                  ...
                  <div id="estados" class=" col-md-3 ">
                    <select id="e"></select>
                  </div>
                  <div id="provincia" class=" col-md-3 ">
                     <select id="pr"></select>
                  </div>
                  <div id="distrito" class=" col-md-3">
                     <select id="di"></select>
                  </div>
                  <div  id="botones" class=" col-md-3">
                    <button class="btn btn-success" onclick="agregarubigeo(<?=$idempresa?>); return false;"><i class="fa  fa-check" ></i></button>
                    <button class="btn btn-danger" onclick="ocultar(); return false;"><i class="fa  fa-close" ></i></button>
                  </div>
                </div>
                </form>
				        <div class="form-group col-md-12" >
