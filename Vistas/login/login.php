...
<div class="login-box">
 ...
 <h4 style="">Planificación de Recursos Empresariales</h4>
  <h1 style="">Grupo - Digamma</h1>
  </div>
  <!-- /.login-logo -->
 ...
 <!-- /
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" name="login" class="btn btn-success btn-block btn-flat">Iniciar</button>
        </div>
