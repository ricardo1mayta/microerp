                  ...
                  <div class="panel panel-default">
                     <div class="panel-heading"> 
                        Orden De Compra Numero:
                         <div class="box-tools pull-right">
                        <button type="button" class="btn btn-success btn-xs " onclick="nuevaorden(<?php echo $usuario['US_C_CODIGO'];?>,'numeroorden','../Vistas/ventas/orden.php')"><i class=" fa fa-user-plus"></i> Nueva Orden</button>
                      </div>
                     </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action=""  >
          ...
          <input type="text" name="q" class="form-control" placeholder="Search..." onkeyup="from2(<?php echo $usuario['US_C_CODIGO']?>,this.value,'client','../Vistas/ventas/clientes.php')">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_prod"  method="post">
              ...
              <div class="col-md-12">
                  <div class="input-group col-md-8">
                  <input type="text" name="search" class="form-control" id="search" placeholder="Search..." onkeyup="from(this.value,'product','../Vistas/ventas/productos.php')">
                      <span class="input-group-btn">
                        <a   class="btn btn-success btn-flat"><i class="fa fa-search"></i>
                        </a>
                      </span>
