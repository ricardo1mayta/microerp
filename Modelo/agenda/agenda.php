...
private $db;
    ...
    {  
     ...
     public function editar_agenda($idage,$detalle,$fini,$ffin,$idus,$color,$e) 
    {  
   echo  $sql = "CALL spa_editar_agenda('$idage','$detalle','$fini','$ffin','$idus','$color','$e');";
